/**
 * Created by hxl on 2015/12/10.
 */
(function() {
    "use strict";
    (function() {
        var NGUeditor;
        NGUeditor = angular.module("openApp");
                ...
                return {
                    ...
                    link: function($S, element, attr, ctrl) {
                        ...
                        _NGUeditor = (function() {
                            ...
                            _NGUeditor.prototype.initEditor = function() {
                                ...
                                return this.editor.ready(function() {
                                    ...
                                    _self.editor.addListener("contentChange", function() {
                                        var _viewValue = ctrl.$viewValue , _content = _self.editor.getContent();
                                        //console.log("_viewValue="+_viewValue + ",_content="+_content);
                                        if (_viewValue !== _content) {
                                            if (typeof _viewValue === "undefined" && _content === "") {
                                                return;
                                            }

                                            //console.log("call setViewValue, _updateByRender="+_updateByRender);
                                            ctrl.$setViewValue(_content);
                                            if (!_updateByRender) {
                                                if (!$S.$$phase) {
                                                    $S.$apply();
                                                }
                            ...
                            _NGUeditor.prototype.setEditorContent = function() {
                                if (this.editor && this.editorReady) {
                                    this.editor.setContent(this.modelContent);
                                }
                            };
